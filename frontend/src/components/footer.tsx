        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-white/50 text-sm leading-relaxed mb-5">
              {config.footer_description || "Platform pelatihan, pengembangan kompetensi, dan konsultasi profesional dari statistik, bisnis, hingga komunikasi."}
            </p>
          ...
          <div>
            ...
            <div className="mt-5 flex items-center gap-3">
              {config.instagram && (
                <a href={config.instagram.startsWith('http') ? config.instagram : `https://www.instagram.com/${config.instagram.replace('@','')}`} target="_blank" rel="noopener noreferrer"
              ...
              {config.social_linkedin && (
                <a href={config.social_linkedin} target="_blank" rel="noopener noreferrer"
                  className="flex items-center justify-center w-9 h-9 bg-white/10 hover:bg-[#0a66c2] rounded-lg transition-colors"
                  aria-label="LinkedIn">
                  <svg className="w-4 h-4 text-white fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
