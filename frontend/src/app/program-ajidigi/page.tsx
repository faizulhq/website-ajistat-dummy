  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4" onClick={onClose}>
      ...
      <div className="relative bg-white rounded-3xl shadow-2xl max-w-md w-full p-7 z-10" onClick={(e) => e.stopPropagation()}>
        ...
        <a href={WA_LINK('Halo, saya ingin tanya lebih lanjut tentang program AjiDigi')} target="_blank" rel="noopener noreferrer"
...
export default function AjiDigiPage() {
  ...
  const ajiDigiFilter = (p: Program) => p.tags.some((t) => t.toLowerCase() === 'ajidigi');
  ...
  return (
    <>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-10">
            ...
            <h2 className="text-3xl font-black text-gray-900">Pilih Format Belajar AjiDigi</h2>
          ...
          <ProgramTabsByFormat programFilter={ajiDigiFilter} queryKey="programs-ajidigi-tabs" />
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl font-black text-gray-900">Topik Program AjiDigi</h2>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <p className="text-[#2348A8] text-sm font-semibold uppercase tracking-widest mb-3">Kenapa AjiDigi?</p>
